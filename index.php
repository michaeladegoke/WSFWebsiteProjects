...
<head>
    ...
    <!-- PAGE TITLE -->
    <title>CKav | Brom - HTML Creative Page</title>
        ...
        <header class="ckav-header">
            <div class="container-fluid padding-0">
                ...
                <div class="row align-items-center">
                    ...
                    <!-- LOGO -->
                    <div class="col">
                        <a href="#" class="logo-wrapper margin-l-30 margin-t-30" 
                        data-ckav-smd="margin-t-10 margin-l-10 margin-b-10 width-px-60">
                    ...
                    <div class="col flex-cr">
                        ...
                        <!-- MENU ICON -->
                        <div class="menu-icon-wrp display-none" 
                        data-ckav-smd="display-flex margin-r-10">
                            <div class="menu-icon">
                                <div class="bar"></div>
                            </div>
                        </div>
                        ...
                        <!-- SOCIAL ICONS -->
                        <div class="social-section margin-r-30 margin-t-30" 
                        data-ckav-smd="display-none">
            ...
            <div class="container zindex-1 typo-light">
                <div class="intro-text width-40" data-ckav-smd="width-100 align-center">
                    <h2 class="heading xlarge bold-600 margin-b-25" data-ckav-smd="large">
                        Attitude <br data-ckav-smd="display-none">is a choice</h2>
                    <p class="heading-sub mini bold-400 margin-b-40" data-ckav-smd="mini margin-b-40">Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem asperiores delectus quas deserunt aliquid illo quos dignissimos culpa</p>
                    <a href="https://themeforest.net/user/c-kav/portfolio" 
                    class="button button-3d color-button-default radius-10 button-large solid">
                    More Info</a>
                </div>
